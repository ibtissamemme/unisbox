...
namespace SandBox
{
    public class PiecePassport : PieceGenerique
    {
        public PiecePassport(List<Champ> listChamp)
        {
        ...
        {
            Program.LogFich.Info("Contenu Piece PassPort:");
            ...
            Program.LogFich.Info(" clef5: " + Clef_5);
        }
    }
}
